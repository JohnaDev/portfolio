...
**Senior Android Developer | Mobile Engineer | Game Developer**  
...
- **Frameworks & Tools:** Android SDK, Jetpack Compose, Firebase, Retrofit, Glide, MVVM  
- **Project Management:** Jira, Trello, OpenProject  
- **Build & Version Control:** Gradle, Git, GitHub  
- **Core Concepts:** RESTful APIs, CI/CD, Material Design, Unit Testing (JUnit, Espresso)  
...
**Overview:**  
A healthcare management app used by home health professionals for scheduling, documentation, and compliance tracking.
...
### 🎮 [Tilt Toby](https://www.amazon.com/Larry-Hall-Machado-Tilt-Toby-Lite/dp/B00GXZSJ1S)
